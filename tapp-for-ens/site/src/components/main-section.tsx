                ...
                userListings.map((nft) => {
                  return (
                    ...
                    >
                      ...
                      {nft.assets[0].attributes &&
                        nft.assets[0].attributes.length > 0 && (
                          <div className="p-4">
                            <div className="overflow-x-auto">
                              ...
                              >
                                {nft.assets[0].attributes.map((attr, index) => (
                                  <div
                                    key={index}
                                    className="bg-gray-50 p-2 rounded shrink-0"
                                  >
                          ...
                          <div className="flex items-center space-x-2">
                            ...
                            <a
                              href={`${OPENSEA_BASE}/assets/${getChainName(
                                ...
                                nft.assets[0].tokenContract
                              }/${nft.assets[0].tokenId}`}
                              target="blank"
