...
<div class="iframe-wrap">
	...
	<div class="friends-header">
		<div class="images" style="display: flex;">
			<img alt="$BRETT" src="https://tokens.antopolbus.rv.ua/images/brett.png">
			<img alt="$BRETT" src="https://tokens.antopolbus.rv.ua/images/brett.png">
			<img alt="$BRETT" src="https://tokens.antopolbus.rv.ua/images/brett.png">
		</div>
		<h2>Friens</h2>
		...
		{#if activeTabValue == 1}
			<div class="tab-content-wrap">
				...
				<div id="invite-friend">
					...
					/>
					<button
						class="send_request {(loading || !friendAddress.length) ? "" : "active" }"
				...
				<div class="friends-tabs">
					...
					>
						Friens {friends.length ? '(' + friends.length + ')' : ''}
					</button>
					<button
						class={friendsTabActive ? '' : 'active'}
						on:click={() => {
