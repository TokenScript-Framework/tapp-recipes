...
<div id="message-popup">
	<div id="message-header">
		<button id="message-close" on:click={() => cleanupAndClose()}><svg width="9" height="15" viewBox="0 0 9 15" fill="none" xmlns="http://www.w3.org/2000/svg">
			<path d="M8.69745 12.6992L3.35412 7.34424L8.69745 1.98924L7.05245 0.344238L0.0524489 7.34424L7.05245 14.3442L8.69745 12.6992Z" fill="#fff"/>
			</svg>
		</button>
		<div id="message-title" title="{thread?.friendsSharedKey && thread?.yourSharedKey
			...
			{:else}
				{selectedFriendAddress.slice(0, 10) + '...' + selectedFriendAddress.slice(-10)}
			{/if}
		</div>
